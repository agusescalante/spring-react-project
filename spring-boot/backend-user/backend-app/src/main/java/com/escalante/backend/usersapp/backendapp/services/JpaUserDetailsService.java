...
public class JpaUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        Optional<com.escalante.backend.usersapp.backendapp.models.entities.User> o = repo.getUserbyUsername(username);
        if (!o.isPresent()) {
            throw new UsernameNotFoundException(String.format("Username %s does not exist", username));
        }

        com.escalante.backend.usersapp.backendapp.models.entities.User user = o.orElseThrow();
